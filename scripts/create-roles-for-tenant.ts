...
const rolesToCreate = [
  ...
  },
  {
    ...
    parentRoleId: null, // Will be set to Business Development Manager role ID
    hierarchyLevel: 2,
    permissions: {
      dashboard: ["view"],
      customers: ["view", "edit", "create"],
  ...
  },
  {
    ...
    parentRoleId: null, // Will be set to General Manager role ID
    hierarchyLevel: 2,
    permissions: {
      dashboard: ["view"],
      customers: ["view", "edit", "create"],
  ...
  },
  {
    ...
    parentRoleId: null, // Will be set to Sales Manager role ID
    hierarchyLevel: 3,
    permissions: {
      dashboard: ["view"],
      customers: ["view", "edit", "create"],
  ...
  },
  {
    ...
    parentRoleId: null, // Will be set to Customer Service Manager role ID
    hierarchyLevel: 3,
    permissions: {
      dashboard: ["view"],
      customers: ["view", "edit", "create"],
  ...
  },
  {
    ...
    parentRoleId: null, // Will be set to Accounts Manager role ID
    hierarchyLevel: 3,
    permissions: {
      dashboard: ["view"],
      invoices: ["view", "edit", "create"],
  ...
  },
  {
    ...
    parentRoleId: null, // Will be set to Sales Supervisor role ID
    hierarchyLevel: 4,
    permissions: {
      dashboard: ["view"],
      customers: ["view", "edit", "create"],
  ...
  },
  {
    ...
    parentRoleId: null, // Will be set to Customer Service Supervisor role ID
    hierarchyLevel: 4,
    permissions: {
      dashboard: ["view"],
      customers: ["view", "edit", "create"],
  ...
  },
  {
    ...
    parentRoleId: null, // Will be set to Accounts Supervisor role ID
    hierarchyLevel: 4,
    permissions: {
      dashboard: ["view"],
      invoices: ["view", "edit", "create"],
  ...
  },
  {
    ...
    parentRoleId: null, // Will be set to Marketing Manager role ID
    hierarchyLevel: 3,
    permissions: {
      dashboard: ["view"],
      leads: ["view", "edit", "create"],
