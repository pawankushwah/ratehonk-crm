  ...
  return (
    <Layout>
      <div className="min-h-screen w-full relative overflow-hidden">
        {/* Sky Background */}
        <div 
          className="absolute inset-0 bg-gradient-to-b from-blue-300 via-blue-400 to-blue-600"
          style={{
            backgroundImage: `url("data:image/svg+xml,%3Csvg width='60' height='60' viewBox='0 0 60 60' xmlns='http://www.w3.org/2000/svg'%3E%3Cg fill='none' fill-rule='evenodd'%3E%3Cg fill='%23ffffff' fill-opacity='0.1'%3E%3Cpath d='M36 34v-4h-2v4h-4v2h4v4h2v-4h4v-2h-4zm0-30V0h-2v4h-4v2h4v4h2V6h4V4h-4zM6 34v-4H4v4H0v2h4v4h2v-4h4v-2H6zM6 4V0H4v4H0v2h4v4h2V6h4V4H6z'/%3E%3C/g%3E%3C/g%3E%3C/svg%3E")`,
          }}
        >
          {/* Cloud shapes */}
          <div className="absolute top-10 left-20 w-32 h-16 bg-white bg-opacity-20 rounded-full blur-sm animate-float"></div>
          <div className="absolute top-32 right-32 w-40 h-20 bg-white bg-opacity-15 rounded-full blur-sm animate-float-delay"></div>
          <div className="absolute top-20 right-20 w-24 h-12 bg-white bg-opacity-25 rounded-full blur-sm animate-float"></div>
        </div>
