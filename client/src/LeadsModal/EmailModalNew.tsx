...
const EmailModalNew: React.FC<EmailModalNewProps> = ({ 
  isOpen, 
  onClose, 
  onSave, 
  editableEmail,
  ...
  useEffect(() => {
    if (editableEmail) {
      form.reset({
        email: editableEmail.email || leadEmail || "",
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-xl font-semibold text-gray-900">
                {editableEmail ? "Edit Lead Email" : "Send Lead Email"}
              </h2>
              <p className="text-sm text-gray-600">
                Compose and send emails to leads
              </p>
            </div>
          </div>
          <button
